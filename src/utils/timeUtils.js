...
export function getTimeBasedGreeting() {
  ...
  const morningGreetings = [
    ...
    "Rise & shine—let's discover your future at ITM Business School today."
  ];

  const afternoonGreetings = [
    "Hey 👋 Hope your day's going well! Ready to learn about ITM's offerings?",
    "Welcome! Perfect time to explore ITM Business School—shall we start?"
  ];

  const eveningGreetings = [
    "Evenings are for planning your future ✨ What interests you about ITM?",
    "Hey! Don't worry if it's late—I'm here to help you discover ITM's programs.",
  ...
  const lateNightGreetings = [
    ...
    "Night owl or future student? Either way—I've got ITM info for you."
  ];
